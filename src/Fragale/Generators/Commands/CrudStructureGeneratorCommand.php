...
class CrudStructureGeneratorCommand extends Command {
	...
	public function fire()
	{
		...
		$this->tryToCopyFile($file, $templateVendorPath.'/views/layouts/checkbootstrap.blade.php', $p->pathViews().'/layouts');
		...
		$this->tryToCopyFile($file, $templateVendorPath.'/views/system/scripts_loader.blade.php', $p->pathViews().'/system/cruds');		
